    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('sarch.report_invoice')}} " method="POST" role="search" autocomplete="off">
                @csrf
            ...
            <div class="card-body">
                <div class="table-responsive">
                         <table id="example" class="table key-buttons text-md-nowrap " style=" text-align: center">
                            ...
                            <tbody>
                               @foreach ($invioce as $x )
                               
                                     <tr>
                                        <td>{{$loop->iteration}}</td>
                                        <td class=" text-primary"> {{$x->invoice_number}} </td>
                                        <td>{{$x-> 	invoice_Date }} </td>
                                        <td> {{$x->due_date }} </td>
                                        <td>
                                  <a href="{{route('cases.invoices',$x->id)}}"> {{$x->section->section_name}}</a>      
                                     </td>
                                        <td>{{$x->discoun }} </td>
                                        <td>{{$x->rate_vat}}</td>
                                        <td> {{$x->status}}</td>
