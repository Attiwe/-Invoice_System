...
<div class="breadcrumb-header justify-content-between">
	<div class="left-content">
		<div>
			...
			<p class="mg-b-0">نظام الفواتير.</p>
		</div>
	</div>
	<div class="main-dashboard-header-lafet">
		<div>
			<label class="tx-13"> التوصل </label>
		...
		<div>
			...
			<a href="https://wa.me/" target="_blank" class="icon-link">
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ number_format(\App\Models\Invoice::sum(DB::raw('amount_collection + amount_commission')), 2) }} $
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير الحالية</p>
                        </div>
                        <a href="{{ route('page.invoice') }}" class="my-auto">
                            <span class="d-flex align-items-center">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="ml-1 text-white op-7">{{ \App\Models\Invoice::count() }} + العدد</span>
                            </span>
                        </a>
                    </div>
                </div>
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ number_format(\App\Models\Invoice::where('status', 'مدفوعة')->sum(DB::raw('amount_collection + amount_commission')), 2) }} $
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير الحالية</p>
                        </div>
                        <span class="float-right my-auto">
                            ...
                            <span class="text-white op-7"> العدد</span>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ number_format(\App\Models\Invoice::where('status', 'مدفوعة جزئيا')->sum(DB::raw('amount_collection + amount_commission')), 2) }} $
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير الحالية</p>
                        </div>
                        <span class="float-right my-auto">
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ number_format(\App\Models\Invoice::where('status', 'غير مدفوع')->sum(DB::raw('amount_collection + amount_commission')), 2) }} $
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير الحالية</p>
                        </div>
                        <span class="float-right my-auto">
                            <i class="fas fa-arrow-circle-up text-white"></i>
                            {{ \App\Models\Invoice::where('status', 'غير مدفوع')->count() }}
                            <span class="text-white op-7"> العدد</span>
                        </span>
                    </div>
                </div>
