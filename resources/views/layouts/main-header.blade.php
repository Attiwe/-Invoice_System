...
<div class="main-header sticky side-header nav nav-item">
    ...
    <a href="#" class="d-flex nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
        <span class="avatar country-Flag mr-0 align-self-center bg-transparent">
            <img src="{{ URL::asset('assets/img/flags/us_flag.jpg') }}" alt="img" style="width: 40px; height: auto;">
        </span>
        <div class="my-auto">
            <strong class="mr-2 ml-2 my-auto">فلسطين</strong>
        </div>
    </a>
</div>
			...
			<div class="nav nav-item  navbar-nav-right ml-auto">
				...
				<div class="dropdown main-profile-menu nav nav-item nav-link">
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>الصفحه الشخصيه</a>
						<a class="dropdown-item" href=""><i class="bx bx-cog"></i>    اعددات النظام</a>
						<a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>الصور</a>
						<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>الرسائل</a>
						<a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i>الاعددات</a>
