                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6>Ebrahim Attiwe</h6>
                                <p>201 Something St., Something Town, YT 242, Country 6546<br>
                                    Tel No: 324 445-4544<br>
                                    Email: ebrahimattiwe@companyname.ai</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    ...
                                    <p>4033 Patterson Road, Staten Cairo, NY 10301<br>
                                        Tel No: 324 445-4544<br>
                                        Email:ebrahimattiwe@companyname.ai</p>
                                </div>
                            </div>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2"> {{ number_format($invoices->discoun , 2) }}</td>
