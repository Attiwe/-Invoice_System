...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    @php $en_id = Crypt::encrypt($invoices->id) @endphp
                    <form action=" {{route('update.status_invoice',$en_id)}}" method="post" autocomplete="off">
                    @csrf
                    @method('PUT')
                    {{-- 1 --}}
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="discoun" name="discoun"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value="{{ $invoices->discoun }}" required readonly>
                            </div>
                        </div>
