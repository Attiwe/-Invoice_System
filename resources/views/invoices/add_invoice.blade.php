...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('store.data')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="يرجي ادخال رقم الفاتورة" required placeholder="    اسم الفاتورة">
                            </div>
                        ...
                        <div class="col">
                            ...
                            <input class="form-control fc-datepicker" name="due_date" placeholder="Y-M-D"
                                type="text" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select name="section_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                onchange="console.log('change is firing')" placeholder="  اسم القسم ">
                                <!--placeholder-->
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="inputName" name="amount_collection" placeholder="100000 Max"
